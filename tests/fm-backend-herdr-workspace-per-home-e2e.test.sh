...
assert_contains_local "$(cat "$SM_META")" "endpoint_task_id=e2esm1" "e2esm1 meta missing endpoint_task_id"
assert_not_contains_local "$(cat "$SM_META")" "treehouse_lease_id=" "e2esm1 meta unexpectedly recorded an ordinary-task Treehouse lease id"
assert_not_contains_local "$(cat "$SM_META")" "treehouse_lease_holder=" "e2esm1 meta unexpectedly recorded an ordinary-task Treehouse lease holder"
